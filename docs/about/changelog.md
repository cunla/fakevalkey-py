...
- Add support for `ZRANGE` arguments for `ZRANGE` command [#127](https://github.com/cunla/fakevalkey-py/issues/127)
...
- Support for redis-py 4.5.0 [#125](https://github.com/cunla/fakevalkey-py/issues/125)

### 🐛 Bug Fixes

- Fix import error for redis-py v3+ [#121](https://github.com/cunla/fakevalkey-py/issues/121)
...
**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v2.5.0...v2.6.0
...
**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v2.4.0...v2.5.0
...
**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v2.3.0...v2.4.0
...
**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v2.2.0...v2.3.0
...
**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v2.1.0...v2.2.0
...
**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v2.0.0...v2.1.0
...
**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v1.10.1...v2.0.0
...
**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v1.10.0...v1.10.1
...
**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v1.9.4...v1.10.0

## v1.9.4

### What's Changed

* Separate LUA support to a different file in [#55](https://github.com/cunla/fakevalkey-py/pull/55)
  **Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v1.9.3...v1.9.4
...
**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v1.9.2...v1.9.3

## v1.9.2

#### What's Changed

* zadd support for GT/LT in [#49](https://github.com/cunla/fakevalkey-py/pull/49)
* Remove `six` dependency in [#51](https://github.com/cunla/fakevalkey-py/pull/51)
* Add host to `conn_pool_args`  in [#51](https://github.com/cunla/fakevalkey-py/pull/51)

**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v1.9.1...v1.9.2

## v1.9.1

#### What's Changed

* Zrange byscore in [#44](https://github.com/cunla/fakevalkey-py/pull/44)
* Expire options in [#46](https://github.com/cunla/fakevalkey-py/pull/46)

**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v1.9.0...v1.9.1

## v1.9.0

#### What's Changed

* Enable redis7 support in [#42](https://github.com/cunla/fakevalkey-py/pull/42)

**Full Changelog**: https://github.com/cunla/fakevalkey-py/compare/v1.8.2...v1.9.0
